...
public:
    ...
    void setPose(double ppose_x, double ppose_y, double ppose_z)
    {
        this->ppose_x = ppose_x;
        this->ppose_y = ppose_y;
        this->ppose_z = ppose_z;
    }
    void getPose(double& ppose_x, double& ppose_y, double& ppose_z)
    {
        ppose_x = this->ppose_x;
        ppose_y = this->ppose_y;
        ppose_z = this->ppose_z;
    }
